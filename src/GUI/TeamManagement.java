...
public class TeamManagement extends javax.swing.JFrame {
    ...
    public TeamManagement() {
        ...
        String assetQuery = "SELECT NAME FROM department";
        String query = "SELECT Name FROM member"; // Assuming the column name is "MemberAs"
        ResultSet nameResultSet = db.runSelect(assetQuery);
        ResultSet memberResultSet = db.runSelect(query); // Use a different variable name for the second ResultSet

        List<String> assetItems = new ArrayList<>();
        List<String> items = new ArrayList<>(); // Renamed to lowercase for better convention
        ...
        try {
            ...
            while (memberResultSet.next()) { // Use the correct ResultSet
                items.add(memberResultSet.getString("Name")); // Use the correct column name
            }

            department.setModel(new DefaultComboBoxModel<>(assetItems.toArray(String[]::new)));
            coach.setModel(new DefaultComboBoxModel<>(items.toArray(String[]::new)));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Team Department");

        jLabel8.setText("Team Coach");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(coach, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String team = (String) this.department.getSelectedItem();
        String tournament = (String) this.coach.getSelectedItem();

        t = new Team(id.getText(), name.getText(), team, tournament);
        t.addData();
